...
def check_copyright(tweet):
    return tweet.find("div", "StreamItemContent--withheld")
...
async def checkData(tweet, config, conn):
    ...
    copyright = check_copyright(tweet)
